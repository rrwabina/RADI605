...
if __name__ == '__main__':
    data_unlabeled = pd.read_csv("H:/Rama/Data Science/2020 - Course Syllabus/RADI605 Modern Machine Learning/session10/unlabeled.csv")
    #data_unlabeled = pd.read_csv("H:/Rama/Data Science/2020 - Course Syllabus/RADI605 Modern Machine Learning/session10/labeled.csv")
    ...
    data_labeled = pd.read_csv("H:/Rama/Data Science/2020 - Course Syllabus/RADI605 Modern Machine Learning/session10/labeled.csv")
